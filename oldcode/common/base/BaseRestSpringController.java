...
import com.vma.code.util.PageTool;
...
public class BaseRestSpringController<Entity, PK> {
	...
	public static void saveIntoModelMap(String tableId, Page page, PageQuery pageQuery, ModelMap model) {
		...
		model.addAttribute("pageToolBar", PageTool.createPageToolBar(page.getThisPageNumber(), 2, page.getPageSize(), page.getTotalCount()));
