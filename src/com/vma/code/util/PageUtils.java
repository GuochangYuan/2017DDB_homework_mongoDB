...
public class PageUtils {
	 ...
	 * @return
	 */
	public static String createPageToolBar(int currentPage,int advancePageNo,int pageSize,int totalCount,String params,String listUrl){
		...
		if(currentPage > 1) {
			pageToolBar.append("<li><a href='"+getPageUrl(1,pageSize,params,listUrl)+"' class='a1'>首页</a></li>");
			pageToolBar.append("<li><a href='"+getPageUrl(currentPage-1,pageSize,params,listUrl)+"' class='a1'>上一页</a></li>");
		}
		
		if(advancePageNo > 0 && currentPage > 1) {
			for(int i=currentPage-advancePageNo<=0?1:currentPage-advancePageNo;i<currentPage;i++) {
				pageToolBar.append("<li><a href='"+getPageUrl(i,pageSize,params,listUrl)+"'>"+i+"</a></li>");
			}
		}
		...
		if(currentPage < totalPage){
			pageToolBar.append("<li><a href='"+getPageUrl(currentPage+1,pageSize,params,listUrl)+"' class='a1'>下一页</a></li>");
			pageToolBar.append("<li><a href='"+getPageUrl(totalPage,pageSize,params,listUrl)+"' class='a1'>末页</a></li>");
		}
