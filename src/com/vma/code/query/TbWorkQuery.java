...
public class TbWorkQuery extends DwzPageQuery implements Serializable {
  ...
  //date formats
	...
	static public String getSortColumns(String orderField,String orderDirection){
		if(StringUtils.isNotBlank(orderField)){
			...
			if(orderField.equals("workName")){
				orderColumns.append("work_name");
			}
	...
	public String getParamString(){
		...
		if(workName != null){
			str.append("&workName=").append(workName);
		}
		if(field1 != null){
