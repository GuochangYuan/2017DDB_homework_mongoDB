...
<html lang="zh-CN">
 <head>
   ...
   <script src="<%=request.getContextPath() %>/js/lhgdialog/lhgdialog.min.js?skin=discuz" type="text/javascript"></script>
   ...
   <script type="text/javascript">
    ...
    function addInfo(){
      $.dialog({id:'jjyw_course',title: '经济业务', content: 'url:http://www.baidu.com', lock: true, width: '600px', height: '400px', padding: '0px',close:function(){
 ...
 <body>
  <div class="container">
     ...
     <div id="button" class="mt10">
       <input type="button" name="button" class="btn btn82 btn_add" value="新增" onclick="addInfo()"> 
